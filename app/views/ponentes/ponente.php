...
<ul class="breadcrumb">
	...
	<li><span class="fa fa-users aqua"></span><a href="<?php echo DIR;?>ponentes"> <?php echo \core\language::show('ponentes', LANGUAGE_INDEX, \helpers\session::get('language')) ?></a></li>
