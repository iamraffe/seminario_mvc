<ul class="breadcrumb">
	...
	<li><span class="fa fa-map-marker"></span> <?php echo \core\language::show('como_llegar', LANGUAGE_INDEX, \helpers\session::get('language')) ?></li>
</ul>
<div class="row">
...
<div class="row">
	<div class="col-md-10 col-md-offset-1 accordion" rel="1">
		<?php echo \core\language::show('direcciones', LANGUAGE_INDEX, \helpers\session::get('language')) ?>		
	</div>
</div>
